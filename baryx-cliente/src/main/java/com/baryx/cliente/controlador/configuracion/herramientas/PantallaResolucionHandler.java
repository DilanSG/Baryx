...
import com.baryx.cliente.BaryxClienteApplication;
...
import com.baryx.cliente.utilidad.ResolucionPerfil;
...
public class PantallaResolucionHandler implements ModalHerramienta {
    ...
    public void abrir() {
        ...
        DetectorPantalla detector = BaryxClienteApplication.getDetectorPantalla();
        if (detector == null) {
